...
export class ServerTotvsService {
  ...
  public ExecutarEmprestimo(params?: any){
    return this.http.post(`${this._url}/ExecutarEmprestimo`, params, { headers:headersTotvs}).pipe(take(1));
  }
  ...
  public onAtualizaDadosEnviados(params?: any){
    return this.http.get(`${this._url}/onAtualizaDadosEnviados`, {params:params, headers:headersTotvs}).pipe(take(1));
  }

  public ObterCadastroHist(params?: any){
    return this.http.get(`${this._url}/ObterCadastroHist`, {params:params, headers:headersTotvs}).pipe(take(1));
  }
